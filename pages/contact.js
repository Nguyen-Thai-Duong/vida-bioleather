                        ...
                        <div className="space-y-6 mb-8">
                            <div className="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">duongntce180478@fpt.edu.vn</p>
                                    <p className="text-gray-600">support@vidabioleather.com</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">FPT University Can Tho Campus</p>
                                    <p className="text-gray-600">Can Tho City</p>
